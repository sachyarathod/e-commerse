...
public class ValidateAutomobileWeightage extends Baseclass 
{
	...
	public void login() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		Utilityclass.wait(driver, 1000);
		home.clickonAnalyzerbutton(driver);
		Utilityclass.wait(driver, 1000);
		home.clickonSegmentButton(driver);
		
		
	}
  @Test
  public void validateweightage() throws IOException, EncryptedDocumentException, InterruptedException 
  {
	  Utilityclass.wait(driver, 1000);
	  
	 Assert.assertEquals(home.getActAutomobileWeightage(driver), Utilityclass.excelreading(driver, 5, 0),"if actual and expectedd are not same TC failed");
     Utilityclass.screenshot(driver, "automobile weightage");
  }
  @Test(priority = -1)
  public void validateAccBalance() throws IOException 
   {
	   ...
	   Utilityclass.screenshot(driver, "Account balance");  
    }
   @AfterMethod
   public void logout()
   {
